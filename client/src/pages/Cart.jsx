          ...
          <div className="lg:w-2/3">
            <div className="bg-white dark:bg-[#1A2218] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
              <ul className="divide-y divide-gray-100 dark:divide-gray-800">
                {cartItems.map((item) => (
                  <li key={item._id} className="p-6 flex flex-col sm:flex-row items-center hover:bg-gray-50 dark:hover:bg-[#202A1F]/50 transition-colors">
                    <img 
                    ...
                    <div className="sm:ml-6 flex-1 text-center sm:text-left">
                      ...
                      <p className="text-sm text-gray-500 dark:text-[#A8B49B] mt-1">{item.category}</p>
