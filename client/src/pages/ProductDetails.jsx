...
const ProductDetails = () => {
  ...
  useEffect(() => {
    // In real app, fetch from API `/api/products/${id}`
        ...
        <div className="bg-white dark:bg-[#1A2218] rounded-3xl shadow-lg border border-gray-100 dark:border-gray-800 overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-10 md:p-14 flex flex-col justify-center">
              ...
              <div className="text-3xl font-bold text-[#CF6B2B] dark:text-[#F58220] mb-6">
                ₹{product.price} <span className="text-sm font-normal text-gray-500 dark:text-gray-400 line-through ml-2">₹{product.price + 50}</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-6">
                ...
                >
                  <ShoppingBag className="w-5 h-5 mr-3" /> Add to Cart (₹{product.price * quantity})
                </button>
              </div>
            </div>
